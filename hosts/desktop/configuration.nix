...
in
{
  ...
  CUSTOM.services.github-runner = {
    ...
    # slice is the sibling fence: a hard memory cap plus equal CPU weights, so
    # a lone runner can still burst across the pool's idle cores.
    resources = {
      pool = {
        memoryMax = "48G";
        memoryHigh = "40G";
  ...
  CUSTOM.virtualisation.openclaw-vm = {
    ...
    tailscale = {
      ...
      sshAuthorizedKeys = [
        ...
        "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIIcNjhPZUPMWwuIqDxZSwAHwcE9qYbdNhQk+14aGFQvQ minttea@thonker"
      ];
    };
  };
