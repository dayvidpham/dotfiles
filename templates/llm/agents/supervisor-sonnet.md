...
1. **Coordinate Parallel Tasks**: Spawn specialized subagents (task-haiku, task-sonnet, task-opus) to work on distinct, independent implementation tasks concurrently
